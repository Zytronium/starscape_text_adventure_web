      ...
      <div className="relative z-10">
        ...
        <footer className="container mx-auto px-6 py-12 mt-32 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-gray-500 text-sm">
            <p>© 2026 <a href="https://zytronium.dev" className="hover:text-yellow-400 transition-colors hover:underline">Zytronium</a>. All rights reserved.</p>

            <div className="flex gap-8">
              <a href="https://github.com/Zytronium/starscape_text_adventure" className="hover:text-yellow-400 transition-colors hover:underline">GitHub</a>
              <a href="https://discord.gg/nMXxW5xVM4" className="hover:text-yellow-400 transition-colors hover:underline">Discord</a>
              <a href="https://stt.gg/2BWGQPa9" className="hover:text-yellow-400 transition-colors hover:underline">Stoat</a>
            </div>
          </div>
        </footer>
      </div>
